<template>
  <div class="page" ref="pagebox">
    ...
    <div id="player" class="player video-wrapper" v-if="player">
      <div
        class="player"
        :class="{ small: voideSamll }"
        :style="{
          width: voideSamll == true ? Width + 'px' : 'auto',
          height: 'auto'
        }"
      >
        <vue-plyr ref="plyr">
...
export default {
  ...
  methods: {
    ...
    goSearch() {
      ...
      let searurl =
        "https://www.googleapis.com/youtube/v3/search?key=AIzaSyCzwjDLmrgCbpy-85dPrn-t-1eFa-zYg6w";
    ...
    Resolve(data) {
      ...
      for (let l in this.dataList) {
        ...
        this.dataList[l]["snippet"]["title"] = this.dataList[l]["snippet"][
          "title"
        ].replace(/&#39;/gi, "'");
      }
    },
    getVideoList(item) {
      ...
      this.$http
        .get(
          "https://www.googleapis.com/youtube/v3/videos?key=AIzaSyCzwjDLmrgCbpy-85dPrn-t-1eFa-zYg6w",
          {
            params: {
              id: item["videoId"],
    ...
    getPlayer(data) {
      ...
      let watch_url =
        "https://www.youtube.com/watch?v=" + data["data"]["items"][0]["id"];
    ...
    getRighList(id) {
      ...
      this.$http
        .get(
          "https://www.googleapis.com/youtube/v3/youtube.channels.list?key=AIzaSyCzwjDLmrgCbpy-85dPrn-t-1eFa-zYg6w",
          {
            params: {
              categoryId: id,
